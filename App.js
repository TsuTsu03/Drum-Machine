...
const styleActiveKey = (key) => {
  key.parentElement.style.backgroundColor = "#0000FF"
  key.parentElement.style.color = "#99999"
}

const deActivatedKey = (audio) => {
  audio.parentElement.style.backgroundColor = "#00FFFF"
  audio.parentElement.style.color = "#00FFFF"
}
